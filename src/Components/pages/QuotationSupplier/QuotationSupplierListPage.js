...
function QuotationSupplierListPage() {
        ...
        <main className="app-main">
            ...
            <div className="app-content-header">
                 <div className="d-flex justify-content-between align-items-center">
                    <h1 className="fs-3">ใบเสนอราคา Supplier</h1>
                    {/* Button should be interactive unless loading */}
                    <Link to="/quotation-supplier/new" className={`btn btn-primary ${isLoading ? 'disabled' : ''}`} aria-disabled={isLoading}>
                        <i className="bi bi-plus-circle me-2"></i>สร้างใบเสนอราคาใหม่
                    </Link>
                </div>
                 <ol className="breadcrumb float-sm-start">
                    <li className="breadcrumb-item"><a href="#" onClick={(e) => {e.preventDefault(); navigate('/')}}>Home</a></li>
                    <li className="breadcrumb-item active" aria-current="page">ใบเสนอราคา Supplier</li>
                </ol>
            </div>
...
export default QuotationSupplierListPage;
